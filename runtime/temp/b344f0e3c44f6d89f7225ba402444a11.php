<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:69:"/opt/web/hqy_/public/../application/v1/view/cate/ifications/edit.html";i:1577181869;s:52:"/opt/web/hqy_/application/v1/view/layout/dialog.html";i:1575880777;s:50:"/opt/web/hqy_/application/v1/view/common/meta.html";i:1575011765;s:52:"/opt/web/hqy_/application/v1/view/common/script.html";i:1575011765;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select id="disablekey" class="selectpicker form-control" multiple  title="请选择..." >
                            ...
                            <option value="<?php echo $key; ?>" data-width="100%" <?php if(in_array($key,$info['disable'])): ?>selected="selected"<?php endif; ?>><?php echo $disable_list; ?></option>
